-- Active: 1778537834875@@127.0.0.1@3306@ifpr_cursos
CREATE TABLE cursos (
...
ALTER TABLE `ifpr_cursos`.`professores` 
DROP FOREIGN KEY `professores_ibfk_1`;
ALTER TABLE `ifpr_cursos`.`professores` 
ADD COLUMN `senha` VARCHAR(64) NULL AFTER `email`;